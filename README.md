...
- [A cleaner approach to write JavaScript (Bonus tips in the end.)](https://dev.to/mirhussain/a-cleaner-approach-to-write-javascript-bonus-tips-in-the-end-58ng)
<!-- BLOG-POST-LIST:END -->
